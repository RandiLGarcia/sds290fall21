...
in this lab, which means you should set a seed on top of your lab. Setting a seed will cause R to select the same 
...
1.  Describe this population distribution using the visualization you just made and these summary
...
sample, we can use the `sample_n` command to sample the population.
...
1.  Would you expect the mean of your sample to match the mean of another student's 
    ...
    just be somewhat different or very different? Ask a neighbor to confirm 
    your answer.
...
1.  Of the sampling distributions from exercise 9 and 10, which has a smaller spread?  If
