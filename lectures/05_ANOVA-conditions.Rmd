...
2. Discriptive statistics (n, means, standard deviations)
3. ANOVA
4. Check assumptions
...
In groups of three run all three steps (visualize, descriptive stats, and ANOVA). Write a sentence about your conclusion from the ANOVA. 
